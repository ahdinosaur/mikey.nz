  ...
  theme: {
    ...
    semanticTokens: {
      colors: {
        ...
        border: {
          DEFAULT: { value: { base: '{colors.purple.200}', _dark: '{colors.teal.800}' } },
          muted: { value: { base: '{colors.purple.100}', _dark: '{colors.teal.900}' } },
          subtle: { value: { base: '{colors.purple.50}', _dark: '{colors.teal.950}' } },
          emphasized: { value: { base: '{colors.purple.300}', _dark: '{colors.teal.700}' } },
          inverted: { value: { base: '{colors.teal.800}', _dark: '{colors.purple.200}' } },
        },
      },
    },
  },
